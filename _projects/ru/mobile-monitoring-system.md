...
### 4.1 Mqtt-клиент
Я исопльзовал клиент Paho MQTT и Android-сервис, предоставляемый Eclipse. 
...
### 5.2. Скрипт для генерации тестовых значений
